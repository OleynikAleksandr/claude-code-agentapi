...
## [0.3.2] - 2025-07-16
### Добавлено
- Динамическое изменение скорости polling при интерактивных вопросах
- Автоматическое ускорение до 150мс при обнаружении вариантов выбора
- Возврат к обычной скорости (1с) после ответа пользователя
### Улучшено
- Более быстрый отклик при навигации стрелками в интерактивных меню
- Мгновенная реакция на выбор пользователя
